...
ax1.text(0, 1.05, '(a)', transform=ax1.transAxes, fontsize=18, fontweight='normal', va='top')
ax2.text(0, 1.05, '(b)', transform=ax2.transAxes, fontsize=18, fontweight='normal', va='top')
ax3.text(0, 1.05, '(c)', transform=ax3.transAxes, fontsize=18, fontweight='normal', va='top')
