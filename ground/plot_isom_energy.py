...
ax1.text(0.05, 1.05, 'A', transform=ax1.transAxes, fontsize=12, fontweight='normal', va='top')
ax1.legend()
...
ax2.text(0.05, 1.05, 'B', transform=ax2.transAxes, fontsize=12, fontweight='normal', va='top')
ax2.legend()
...
ax3.text(0.05, 1.05, 'C', transform=ax3.transAxes, fontsize=12, fontweight='normal', va='top')
ax3.legend()
