...
ax2.text(0.05, 0.9, 'b)', transform=ax2.transAxes, fontsize=12, fontweight='bold', va='top')
ax2.legend()
...
ax3.text(0.05, 0.9, 'c)', transform=ax3.transAxes, fontsize=12, fontweight='bold', va='top')
ax3.legend()
